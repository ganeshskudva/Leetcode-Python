class Solution:
    def calculate(self, s: str) -> int:    
        def calc(it: int):
            ...
            # Initialize variables: num for current number, stack to hold values, sign for current operator.
            num, stack, sign = 0, [], "+"
            ...
            while it < len(s):
                if s[it].isdigit():                    # If the current character is a digit.
                    ...
                    num, it = calc(it + 1)            # Recursively call calc for the inner expression.
